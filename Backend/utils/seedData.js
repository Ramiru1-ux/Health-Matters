...
const Appointment_1 = __importDefault(require("../src/models/Appointment"));
const MedicalRecord_1 = __importDefault(require("../src/models/MedicalRecord"));
...
const seedDatabase = async () => {
    try {
        ...
        await Referral_1.default.deleteMany({});
        ...
        // 3 Practitioners
        const practitioner1 = await User_1.default.create({
        ...
        const practitioner2 = await User_1.default.create({
        ...
        const practitioner3 = await User_1.default.create({
        ...
        // 3 Managers
        const manager1 = await User_1.default.create({
        ...
        const manager2 = await User_1.default.create({
        ...
        const manager3 = await User_1.default.create({
        ...
        // 8 Employees
        const employee1 = await User_1.default.create({
        ...
        const employee2 = await User_1.default.create({
        ...
        const employee3 = await User_1.default.create({
        ...
        const employee4 = await User_1.default.create({
        ...
        const employee5 = await User_1.default.create({
        ...
        const employee6 = await User_1.default.create({
        ...
        const employee7 = await User_1.default.create({
        ...
        const employee8 = await User_1.default.create({
        ...
        const service1 = await Service_1.default.create({
        ...
        const service2 = await Service_1.default.create({
        ...
        const service3 = await Service_1.default.create({
        ...
        const service4 = await Service_1.default.create({
        ...
        const service5 = await Service_1.default.create({
        ...
        const referral1 = await Referral_1.default.create({
        ...
        const referral2 = await Referral_1.default.create({
        ...
        const referral3 = await Referral_1.default.create({
        ...
        console.log(`   - Services: ${await Service_1.default.countDocuments()}`);
        console.log(`   - Referrals: ${await Referral_1.default.countDocuments()}`);
        console.log(`   - Appointments: ${await Appointment_1.default.countDocuments()}`);
        console.log(`   - Medical Records: ${await MedicalRecord_1.default.countDocuments()}`);
